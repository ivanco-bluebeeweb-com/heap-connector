"""Panel UI for Heap Connector following UI_INTERFACE_STANDARD.md."""
...
def _help_modal() -> ui.UINode:
    return ui.Modal(
        ...
        children=[
            ui.Text(
                "1. Sign in to your Heap dashboard and navigate to API/Integration settings.\n"
...
async def main_panel(ctx) -> ui.UINode:
    ...
    return ui.Stack(
        ...
        gap=2,
        children=[
            ui.Heading("Heap Connector", level=3),
            ui.Text("Connect and manage your Heap workspace.", variant="caption"),
            ui.Divider(),
            form,
            ui.Divider(),
            _help_modal(),
